...
public class IdeProjectDescriptor extends ProjectDescriptor {
  ...
  public PomFile pom() {
    ...
    final Procedure1<PomFile> _function = (PomFile it) -> {
      ...
      {
        if ((this.getConfig().isCreateLanguageServerJar() && this.isEclipsePluginProject())) {
      ...
      {
        boolean _isCreateLanguageServerJar = this.getConfig().isCreateLanguageServerJar();
        if (_isCreateLanguageServerJar) {
          {
            ...
            if (_isEclipsePluginProject_1) {
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t");
              _builder.append("<includeArtifactIds>");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t ");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtext.util");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtext.xbase");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtext.xbase.ide");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtext.xbase.lib");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtext.common.types");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtend.lib");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.xtend.lib.macro");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.equinox.common");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",com.google.inject");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.emf.common");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.generator");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",org.eclipse.jsonrpc");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              ...
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",asm-tree");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",asm-commons");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t\t");
              _builder.append(",aopalliance");
              _builder.newLine();
              _builder.append("\t\t");
              _builder.append("\t\t\t\t");
              _builder.append("</includeArtifactIds>");
  ...
  public GradleBuildFile buildGradle() {
    ...
    final Procedure1<GradleBuildFile> _function = (GradleBuildFile it) -> {
      ...
      {
        boolean _isCreateLanguageServerJar_1 = this.getConfig().isCreateLanguageServerJar();
        if (_isCreateLanguageServerJar_1) {
          _builder_1.newLine();
