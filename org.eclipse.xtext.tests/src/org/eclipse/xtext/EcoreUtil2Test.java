...
public class EcoreUtil2Test extends AbstractXtextTests {
	...
	@Test public void testPathFragment() {
		...
		assertEquals("/-1", EcoreUtil2.getPathURIFragment(foo));
		assertEquals("/-1", EcoreUtil2.getPathURIFragment(bar));
		assertEquals("/-1", EcoreUtil2.getPathURIFragment(p));
		Resource resource = new ResourceImpl(URI.createURI("platform:/resource/res"));
		resource.getContents().add(p);
		assertEquals(URI.createURI("platform:/resource/res#//@eClassifiers.0"), EcoreUtil2.getPathURI(foo));
		assertEquals(URI.createURI("platform:/resource/res#//@eClassifiers.1"), EcoreUtil2.getPathURI(bar));
		assertEquals(URI.createURI("platform:/resource/res#/"), EcoreUtil2.getPathURI(p));
